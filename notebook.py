...
for col in cc_apps.columns:
    ...
    # Use LabelEncoder to do the numeric transformation
        ccappas_dict = {k:i for i, k in enumerate(cc_apps[col].unique(), 0)} 
        cc_apps.loc[:,col]=cc_apps.loc[:,col].map(ccappas_dict)
cc_apps.info()
...
print(rescaledX_test.max())
print(rescaledX_test.min())
print(rescaledX_train.max())
print(rescaledX_train.min())
